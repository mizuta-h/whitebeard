...
text-decoration: none;
    ...
    .is-layout-flex .wp-block-image{ padding: 0 5px;}
    ...
    .is-layout-flex .wp-block-image img{ width: 100%; height: 24vw; object-fit: cover}
    
    .is-layout-flex .wp-block-group{ width: 50%; padding: 0 5px;}
    
    .dtcon p, .dtcon ol, .dtcon ul {
    font-size: 14px;
    line-height: 30px;
    padding: 25px 0;
}
...
if ( $categories ) {
	foreach ( $categories as $category ) {
		echo '<dt class="'.$category->slug.'">'.$category->name.'</dt>';
	}
}
?>
				...
				<h1> <?php the_title(); ?></h1>
				 <?php the_content(); ?>
				  ...
				  <p class="listbackBtn"><a href="/information"><img src="<?php echo get_template_directory_uri(); ?>/img/infomation/listback.svg" alt=""></a></p>
				</div>
